...
String MainPage(int client_count) {
  ...
  html += "<meta name='viewport' http-equiv='refresh' content='3' content='width=device-width, initial-scale=1'>";
  ...
  for (int i = 0; i < client_count; i++) {
    ...
    html += "<div class='shutdown-button' onclick='shutdownClient(" + String(i + 1) + ")'>ks</div>";
